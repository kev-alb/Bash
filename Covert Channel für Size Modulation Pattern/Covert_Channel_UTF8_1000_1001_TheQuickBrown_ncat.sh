...
#Der Channel sendet Pakete der Größen 1000 Byte (0-Bit) und 1001 Byte (1-Bit) mittels ncat.
#Alternativ kann auch über echo unten 10 bzw. 11 Byte gesendet werden. Dann kann sleep ebenfalls
#einen kleineren Wert bekommen.
...
#Senden der Pakete/Dateien mit netcat.
...
while true; do
	...
	for i in "${kod[@]}"; do
		...
		then
			#echo "ZehnBytee"
			cat 0Bit_1000ByteSize.txt
		else
			#echo "ElfByteeee"
			cat 1Bit_1001ByteSize.txt
		fi
